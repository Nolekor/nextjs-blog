...
export const allBlogs = [automatingRepetitiveTasksProductivityHacksForDevelopers__indexMdx, jsFrameworksComparison__indexMdx, bestPracticesForWritingCleanAndMaintainableCode__indexMdx, buildingProgressiveWebAppsBridgingTheGapBetweenWebAndMobile__indexMdx, progressiveWebAppsPwa__indexMdx, mindfulnessAndMeditationTechniquesForDevelopersImprovingFocusAndClarity__indexMdx, restfulApisBuildingBlocks__indexMdx, masteringCssGridLayout__indexMdx, webAccessibilityBestPractices__indexMdx, webDevelopmentToolsProductivity__indexMdx, webAccessibilityInclusiveDesign__indexMdx]
