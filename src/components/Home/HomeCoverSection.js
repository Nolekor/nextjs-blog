...
export const HomeCoverSection = ({ blogs }) => {
    ...
    return (
        <div className="w-full inline-block">
            <article className="flex flex-col items-start justify-end sm:mx-10 mx-5 relative sm:h-[85vh] h-[60vh]">
                ...
                <div className="w-full lg:w-3/4  p-6 sm:p-8 md:p-12 lg:p-16 flex flex-col items-start justify-center z-0 text-light">
                    ...
                    <p className=" hidden sm:inline-block mt-4 text-lg lg:text-xl font-in ">
                        {blog.description}
                    </p>
                </div>
            </article>
